...
handler.get(async (req, res, next) => {
  try {
    ...
    const alumni = await _models_Alumni_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].find */ .Z.find({
      isAdmin: false
    }).limit(5);
    res.send(alumni);
  } catch (error) {
...
var __webpack_exports__ = __webpack_require__.X(0, [632], () => (__webpack_exec__(3999)));
