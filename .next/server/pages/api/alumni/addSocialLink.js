...
handler.post(async (req, res, next) => {
  try {
    ...
    await _models_Alumni_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].updateOne */ .Z.updateOne({
      _id: req.query.id
    }, {
      socialLinks: {
...
var __webpack_exports__ = __webpack_require__.X(0, [632], () => (__webpack_exec__(2623)));
