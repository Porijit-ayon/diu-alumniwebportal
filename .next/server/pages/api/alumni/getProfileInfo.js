...
handler.get(async (req, res, next) => {
  try {
    ...
    const profileInfo = await _models_Alumni_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].findOne */ .Z.findOne({
      email: req.query.email
    });

    if (profileInfo.phone && profileInfo.gander && profileInfo.address && profileInfo.maritalStatus && profileInfo.dateOfBirth && profileInfo.vrstyName && profileInfo.dep && profileInfo.batch && profileInfo.passingYear && profileInfo.cgpa && profileInfo.professionalTitle && profileInfo.favoritSubject && profileInfo.expOrFra && profileInfo.currentJob && profileInfo.skills && profileInfo.socialLinks) {
      res.send({
...
var __webpack_exports__ = __webpack_require__.X(0, [632], () => (__webpack_exec__(3476)));
